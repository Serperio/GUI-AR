...
public class MyPositionGPS : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Comenzar la obtención de la ubicación
        StartCoroutine(StartGPS());
    }
    private System.Collections.IEnumerator StartGPS()
    {
        // Esperar hasta que se otorgue el permiso de ubicación (solo necesario para Android)
        ...
        {
            Debug.LogError("No se pudo obtener la ubicación del GPS.");
            yield break;
        }
    ...
    void Update()
    {
        ...
        // Obtener la posición actualizada si está disponible
    ...
    {
        // Detener el servicio de ubicación al salir de la aplicación
        Input.location.Stop();
    }
